...
svy <- update(svy, nhd.change3 = recode_factor(dcas$nhd.change, "Much better"="Better", "Somewhat better"="Better", "About the same" = "Same", "Somewhat worse" = "Worse", "Much worse" = "Worse")) %>%
    update(nhd.change3 = relevel(nhd.change3, ref = "Same"))

des <- as.svrepdesign(svy, type="bootstrap" , replicates=250)
m3m_bet <- svymultinom(as.formula(paste('nhd.change3 ~', m1)),
                       design = des)
