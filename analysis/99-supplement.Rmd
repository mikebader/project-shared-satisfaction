...
The data from the DCAS 2016 raise the issue that I, by construction, only received responses from residents who chose not to move out and residents who selected multiracial neighborhoods. The theories that I test in the paper suggest that these two problems will be larger among white residents than among residents of color. 

The between-neighborhood analyses, to some degree, address the selection of white residents *into* neighborhoods. Comparing the pool of white residents in the DC area, I observed differences between the satisfaction of that pool overall and the satisfaction of whites living in multiracial neighborhoods. If white residents who valued diversity above other amenities sought multiracial neighborhoods, then satisfaction would be as high among whites in multiracial neighborhoods as among whites in other neighborhoods.[^recent-movers]
...
```{r supp-satisfied-years-whites, fig.cap="Satisfaction by length of residence among whites in multiracial neighborhoods", message=FALSE}
...
While the analyses above cannot definitively reject selection effects, they mitigate against the fear that the results showing shared satisfaction mask the strongest selection effects. Among whites, the group previous research suggests would be the most likely to be affected by integration, including the length of residence does not improve the fit of the model. About half of whites moved into multiracial neighborhoods in the past 10 years, yet the share of satisfied residents in this group did not differ from the share among whites who moved into multiracial neighborhoods 20, 30, or 40 years prior. These data cannot answer whether the whites who left in the intervening decades did so because their neighborhoods integrated. The analyses provide evidence, however, that a shared satisfaction among *current* residents will persist, and are further supported by the fact that interracial differences in satisfaction were not systematically related to the share of the white population that left.
