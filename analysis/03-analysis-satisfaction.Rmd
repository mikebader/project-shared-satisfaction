# Analysis
## Analytical Approach
For each analysis, run three models. 

1. Race-only model
2. Race and demographic controls
3. Race, demographic, and neighborhood context variables

* Can't "prove a null" in this case, so will examine how much overlap there is in the confidence intervals (I need to work on explaining this better; any suggestions would be most welcome)
...
```{r descriptive-output, echo=TRUE}
