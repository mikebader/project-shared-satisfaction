...
Overall `r round(consany_mean*100)` people would consider living in one of the eleven communities named in the survey. Among whites, `r probs[1]`% would consider at least one of the eleven other multiethnic neighborhoods on the list; among Asians `r probs[2]`%, among blacks, `r probs[3]`%, and among Latinos `r probs[4]`%.
