---
title: Level Interracial Variation in Satisfaction with Multiracial Neighborhoods
author: Michael D.`\`{=latex} M.`\`{=latex} Bader
abstract: |
    Need to write abstract.
keywords:
- racial integration
- neighborhood change
- housing
...
Multiracial neighborhoods---those shared among Asian, black, Latinx, and white neighbors---have become common in U.S. metropolitan areas since the 1980s. @logan_global_2011 estimated that 38 percent of neighborhoods in 2010 were what they termed "global neighborhoods." Similarly, @bader_fragmented_2016 found stable multiracial integration, what they called "quadrivial neighborhoods," represented between eight and twenty percent of neighborhoods in the metropolitan areas of the four largest cities. That multiracial neighborhoods emerged to an appreciable number of neighborhoods from barely existing three decades ago reflects a change in the relationship between between race and metropolitan space. 

Empirically, however, racial integration has reduced levels of neighborhood satisfaction. Lower neighborhood satisfaction can decrease attachment residents feel to their neighbors and neighborhoods, reduce a sense of collective efficacy, and ultimately lead people to move out \needcite. The reason for lower satisfaction has been the subject of debate. Social disorganization theories posit that racial differences reduce social capital and trust that lead to lower satisfaction. These theories predict low levels of satisfaction among all racial groups living in multiracial neighborhoods. Racial stratification theories predict that white residents with resources will flee integrating neighborhoods, leaving the most disgruntled white residents in integrated neighborhoods. Finally, neighborhood lifecourse theories argue that neighborhood change leads to dissatisfaction, and heterogeneity acts as a proxy of this underlying change. 

All three groups of theories imply that racial integration creates dissatisfaction, destabilizes neighborhoods, and ultimately lead to neighborhood racial change. This paper presents evidence in favor of an alternative hypothesis: residents of all races feel sufficiently satisfied living in *multiracially* integrated neighborhoods to provide a basis for stable racial integration. I test this alternative hypothesis using data from a representative sample of residents living in multiracial neighborhoods in the Washington, DC area. I find that residents of all racial groups are similarly satisfied living in multiracial neighborhoods. I further find that, compared to metropolitan residents overall, only whites show a lower level of neighborhood satisfaction in multiracial neighborhoods. 

* Possibility for progress
* Present new challenges that research and policy must confront

# Neighborhood Satisfaction in Racially Integrated Neighborhoods

The existence of multiracial neighborhoods leads back to the progress won by the Civil Rights Movement in the 1960s. The Fair Housing Act outlawed discrimination in real estate. While its impact was neither immediate nor universal, the Act provided a legal mechanism to challenge blatant forms of racial discrimination. Immigration reform reflected another success of the Civil Rights Movement that increased increased the diversity of the American populace through immigration from Latin America and Asia. Finally, white attitudes toward blacks specifically and people of color generally have become more tolerant in the wake of the Civil Rights Movement. 

Despite the progress evident in the legacy of these laws and decreasing racial animosity, the US remains a segregated nation. Where integration has taken root, it has germinated in formerly all-white neighborhoods as people of color have moved in. While some neighborhoods subsequently transitioned to have no whites, many others remained racially integrated. *Multiracial* integration has been more likely to persist compared to neighborhoods shared among only two groups. 

## Change-Based Theories of Racial Integration

While the growing prevalence of multiracial neighborhoods would seem to presage a growing desire for integrated neighborhoods, research generally finds that racial integration is related to lower neighborhood satisfaction. Researchers have developed several theories to explain why racial integration diminishes neighborhood satisfaction. I sort the different theories into three classes below based on the similarities of mechanisms thought to affect neighborhood satisfaction. 
...
In the most comprehensive study to date on the topic of residential satisfaction, Hipp -@hipp_specifying_2009 found that racial heterogeneity had a strong negative effect on satisfaction using American Housing Survey data from 1987 to 1999. Woldoff -@woldoff_effects_2002 also found that social disorganization lowered neighborhood attachment based on data from Nashville residents collected in 1988. Legewie and Schaeffer -@legewie_contested_2016 showed that complaints of minor incivilities reported to New York City's 311 service in the early 2010s, were higher in integrated neighborhoods because they represented contested boundaries. These studies indicate a general sense of declining neighborhood satisfaction among residents of integrated neighborhoods.

A second class of models focus on *racial stratification* to explain lower satisfaction. The defended neighborhoods hypothesis argues that existing residents establish and maintain neighborhood boundaries to exert control [@suttles_social_1972]. Incursion by people of color into all-white neighborhoods leads to violent responses or appeals to the municipal authorities to resolve disputes. If those efforts fail to stymie the influx of racial outsiders, those with the means to do so leave the neighborhood [@sugrue_origins_1996; @green_defended_1998]. This view of neighborhoods as communities of "limited liability" implies that the most disgruntled whites and those least satisfied with neighborhood changes, would remain in the neighborhood [@janowitz_community_1967]. This process also implies the stratification of neighborhoods as whites with resources leave, leading to lower housing demand, as people of color enter the neighborhood. 

In contrast to the social disorganization theory, racial stratification theories imply that incumbent residents will be less satisfied than incoming residents. Swaroop and Krysan -@swaroop_determinants_2011 found evidence that neighborhood satisfaction was lower among whites who lived in neighborhoods with fewer whites. Greif -@greif_intersection_2015 found that whites generally had the highest neighborhood satisfaction, and that black and Latino homeowners were especially sensitive to problematic social conditions. Studies of moves out of neighborhoods, an indirect measure of neighborhood dissatisfaction, find that whites are more likely to leave neighborhoods as the percentage of non-whites increases. The theories would expect that the whites left behind after the unsuccessful "defense" of racial boundaries would be especially dissatisfied in the neighborhood. Inversely, people of color are especially attracted to integrated neighborhoods while whites are not. Swaroop and Krysan -@swaroop_determinants_2011, for example, found *higher* neighborhood satisfaction among Latinos who lived in neighborhoods with fewer Latinos.
...
Two hypotheses arise from this recent evidence of neighborhood satisfaction in multiracial neighborhoods:

Hypothesis 1:

: most residents of multiracial neighborhoods will be satisfied with their neighborhood, but satisfaction will be lower among residents of multiracial neighborhoods than residents of the metropolitan area as a whole
...
The analyses used a dichotomous measure of neighborhood satisfaction. Both surveys asked respondents, "How satisfied are you with your neighborhood as a place to live?," a question that has been used in previous research [see, e.g., @woldoff_effects_2002; @greif_intersection_2015]. To measure current neighborhood *satisfaction*, respondents who indicated that they were "extremely" or "very" satisfied living in their neighborhood were coded as being satisfied. Those who indicated that they were "somewhat" or "not at all" satisfied were coded as being unsatisfied.

## Independent Variable
A measure created from respondents' self-identified race and ethnicity was the independent variable in all analyses. I classified racial groups into four mutually exclusive categories based on the respondents' answers to questions about race (respondents were allowed to choose multiple racial groups) and Hispanic ethnicity. I classified those respondents who indicated Hispanic ethnicity as *Latinx*, regardless of their race. Among the remaining non-Latinx respondents, I classified as *white* those who selected white as their only race; as *black* those identified as black, either alone or in combination with any other race; and as *Asian* those who identified as Asian or Pacific Islander, either alone or in combination with any race other than black. Respondents missing on either the race question or the ethnicity question and respondents who did not satisfy the criteria above were not included in the analysis. This left a final analytic dataset of **{N(2016)}** respondents in 2016 and **{N(2018)}** respondents in 2018.
...
These findings provide evidence that residents of all races are equally satisfied living in multiracial neighborhoods. White residents, who the racial stratification theories would predict to be dissatisfied living in multiracial neighborhoods had similar were just as satisfied as their neighbors of color. The results instead reveal high levels of satisfaction shared equally among residents, and these levels of satisfaction could serve to maintain racial integration. 

## Racial Differences in Perceptions of Neighborhood Change

I tested the robustness of this finding by also analyzing racial variation in how residents of multiracial neighborhoods evaluated the changes that had occurred in their neighborhoods. The measure provides extra evidence to test whether groups, in particular whites who remain in place, do so despite believing that their neighborhoods have gotten worse. The survey asked for responses to the prompt, "Looking back over the past five years or so, would you say that your neighborhood has...," and allowed respondents to choose from five responses: become a much better (worse) place to live, become a somewhat better (worse) place to live, or stayed about the same. I recoded responses into three categories representing whether respondents reported their neighborhoods getting better, worse, or staying the same. Because this was one of the first questions asked on the survey, and because it came before any questions about the respondent's own race or racial attitudes, respondents were not primed to think about neighborhood changes in the context of racial change. 

Overall, 34.5 percent of all residents living in multiracial neighborhoods think that their neighborhoods improved over the previous five years. In contrast, only 11.5 percent of residents think that their neighborhoods got worse. Just over half, 54.0 percent think that the neighborhood stayed the same. 

Figure @fig:change plots the percentage residents, by race, that think that their neighborhoods have gotten better, gotten worse, or stayed the same. White residents were equally likely as black and Latino residents to report that multiracial neighborhoods have gotten worse, contrary to the theoretical expectation that whites would perceive neighborhood declines. White residents were, however, less likely to think that the neighborhood had improved: only 26.9 percent report who their neighborhoods while 60.4 percent who believed that the neighborhood had stayed the same. In comparison, 37.8 percent of Asian residents, 36.9 percent of black residents, and 39.5 percent of Latino residents reported that their neighborhoods had improved. 
...
The significant interracial variation persisted after controlling for other characteristics in a regression analysis. Table \ref{tab:change} reports estimates of a race-only model and a model with the complement of controls, including neighborhood fixed effects, predicting perceived neighborhood improvement. Racial differences diminished only slightly in the models that included controls, especially the differences between whites and both blacks and Latinos. The average marginal effects of race in comparison to white residents on neighborhood satisfaction from the full model were 13.8 percent for black residents ($p{=}0.006$), 14.4 percent for Latinos ($p{=}0.010$), and 10.5 percent for Asians ($p{=}0.033$). The data fit the model including race better than the model without race.[^multinomial]
...
White residents' lower propensity to perceive neighborhood improvement compared to their neighbors of color provides some evidence that whites might be eager to experience integration. But this finding lends only modest support to the racial stratification theory. Whites were not more likely than their neighbors to perceive neighborhood decline. Instead, whites perceived a stable trajectory of neighborhood change. Perceptions of stability combined with the generally high satisfaction among whites reported in the first analysis reduce the probability that white residents move out of multiracial neighborhoods. 
