...
[^opportunity-hoarding]: \label{rev:hoarding}\revision{A few examples of the opportunity hoarding in the past five years include opposing school district boundary changes for fear of property value declines in one district and shouting down researchers at an event planning for *potential* redistricting plans in another one }[@woolsey_opposition_2019; @peetz_this_2019]\revision{, opposing homeless shelter location in wealthy and disproportionately white wards of the city on the basis that "Homeless lives matter; the lives of community homeowners matter too" }[@alpert_upper_2016] \revision{, fiercely opposing zoning in single-family neighborhoods }[@koma_valors_2020]. 
